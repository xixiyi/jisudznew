          ...
          <div class="inner-container">
            ...
            >
              <el-submenu index="1" class="menuManager_1">
                ...
                <el-menu-item
                  index="1-1"
                  class="menuManager_1_1"
                  data-src="order"
                  data-title="购货订单"
                >购货订单</el-menu-item>
                <el-menu-item
                  index="1-2"
                  class="menuManager_1_2"
                  data-src=""
                  data-title="购货单"
                >购货单</el-menu-item>
                <el-menu-item
                  index="1-3"
                  class="menuManager_1_3"
                  data-src="shopOrder"
                  data-title="购货退货单"
                >购货退货单</el-menu-item>
                <el-menu-item
                  index="1-4"
                  class="menuManager_1_4"
                  data-src=""
                  data-title="购货明细"
                >购货明细</el-menu-item>
              </el-submenu>
              <el-submenu index="2" class="menuManager_2">
                ...
                <el-menu-item
                  index="2-1"
                  class="menuManager_2_1"
                  data-src=""
                  data-title="销售订单"
                >销售订单</el-menu-item>
                <el-menu-item
                  index="2-2"
                  class="menuManager_2_2"
                  data-src=""
                  data-title="销售单"
                >销售单</el-menu-item>
                <el-menu-item
                  index="2-3"
                  class="menuManager_2_3"
                  data-src="www.baidu6.com"
                  data-title="销售完成订单"
                >销售完成订单</el-menu-item>
                <el-menu-item
                  index="2-4"
                  class="menuManager_2_4"
                  data-src="www.baid7u.com"
                  data-title="销售退货单"
                >销售退货单</el-menu-item>
                <el-menu-item
                  index="2-5"
                  class="menuManager_2_5"
              ...
              <el-submenu index="3" class="menuManager_3">
                ...
                <el-menu-item
                  index="3-3"
                  class="menuManager_3_3"
                  data-src="www.baidu.c08om"
                  data-title="报损报溢"
                >报损报溢</el-menu-item>
                <el-menu-item
                  index="3-4"
                  class="menuManager_3_4"
                  data-src="www.baidu087.com"
                  data-title="库存详情"
                >库存详情</el-menu-item>
                <el-menu-item
                  index="3-5"
                  class="menuManager_3_5"
                  data-src="www.0674.com"
                  data-title="库存报警"
                >库存报警</el-menu-item>
                <el-menu-item
                  index="3-6"
                  class="menuManager_3_6"
              ...
              <el-submenu index="4" class="menuManager_4">
                ...
                <el-menu-item
                  index="4-1"
                  class="menuManager_4_1"
                  data-src="www.w3465.com"
                  data-title="生产订单"
                >生产订单</el-menu-item>
                <el-menu-item
                  index="4-2"
                  class="menuManager_4_2"
                  data-src="www.123ser.com"
                  data-title="生产报表"
                >生产报表</el-menu-item>
                <el-menu-item
                  index="4-3"
                  class="menuManager_4_3"
                  data-src="www.bairewdu.com"
                  data-title="生产进度"
                >生产进度</el-menu-item>
                <el-menu-item
                  index="4-4"
                  class="menuManager_4_4"
                  data-src="www.wer.com"
                  data-title="生产业绩"
                >生产业绩</el-menu-item>
                <el-menu-item
                  index="4-5"
                  class="menuManager_4_5"
                ...
                <el-menu-item
                  index="4-6"
                  class="menuManager_4_6"
                  data-src="www.bagsridu.com"
                  data-title="原材料管理"
                >原材料管理</el-menu-item>
                <el-menu-item
                  index="4-7"
                  class="menuManager_4_7"
              ...
              <el-submenu index="5" class="menuManager_5">
                ...
                <el-menu-item
                  index="5-1"
                  class="menuManager_5_1"
                  data-src="www.bsfgaidu.com"
                  data-title="客服沟通表"
                >客服沟通表</el-menu-item>
                <el-menu-item
                  index="5-2"
                  class="menuManager_5_2"
                  data-src="www.baresidu.com"
                  data-title="样本发放表"
                >样本发放表</el-menu-item>
                <el-menu-item
                  index="5-3"
                  class="menuManager_5_3"
                  data-src="www.baidgrfeu.com"
                  data-title="市场调查表"
                >市场调查表</el-menu-item>
                <el-menu-item
                  index="5-4"
                  class="menuManager_5_4"
                  data-src="www.baisrdu.com"
                  data-title="售后回访表"
                >售后回访表</el-menu-item>
                <el-menu-item
                  index="5-5"
                  class="menuManager_5_5"
              ...
              <el-submenu index="6" class="menuManager_6">
                ...
                <el-menu-item
                  index="6-1"
                  class="menuManager_6_1"
                  data-src="www.baidsrtesu.com"
                  data-title="客户管理"
                >客户管理</el-menu-item>
                <el-menu-item
                  index="6-2"
                  class="menuManager_6_2"
                  data-src="www.baitredu.com"
                  data-title="供应商管理"
                >供应商管理</el-menu-item>
                <el-menu-item
                  index="6-3"
                  class="menuManager_6_3"
                  data-src="www.baidsfgu.com"
                  data-title="商品管理"
                >商品管理</el-menu-item>
                <el-menu-item
                  index="6-4"
                  class="menuManager_6_4"
                  data-src="www.baidgreu.com"
                  data-title="员工管理"
                >员工管理</el-menu-item>
              </el-submenu>
              <el-submenu index="7" class="menuManager_7">
                ...
                <el-menu-item
                  index="7-1"
                  class="menuManager_7_1"
                  data-src="www.baisdgrdu.com"
                  data-title="xxx"
                >xxx</el-menu-item>
                <el-menu-item
                  index="7-2"
                  class="menuManager_7_2"
                  data-src="www.baidsgrdu.com"
                  data-title="xxx"
                >xxx</el-menu-item>
                <el-menu-item
                  index="7-3"
                  class="menuManager_7_3"
                  data-src="www.basrfidu.com"
                  data-title="xxx"
                >xxx</el-menu-item>
                <el-menu-item
                  index="7-4"
                  class="menuManager_7_4"
              ...
              <el-submenu index="8" class="menuManager_8">
                ...
                <el-menu-item
                  index="8-1"
                  class="menuManager_8_1"
                  data-src="www.baidweru.com"
                  data-title="模块管理"
                >模块管理</el-menu-item>
                <!-- <el-menu-item index="8-2">菜单管理</el-menu-item> -->
                <el-menu-item
                  index="8-2"
                  class="menuManager_8_2"
...
export default {
  ...
  data() {
    return {
      ...
      isCollapse: true,
      clientHeight: { height: "" },
      iframeStyle: { width: "100%", border: "0","overflow-x":"hidden","overflow-y":"scroll", height: "" },
      headstyle: {
